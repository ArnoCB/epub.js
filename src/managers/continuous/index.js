...
const snap_1 = __importDefault(require("../helpers/snap"));
...
class ContinuousViewManager extends default_1.default {
    ...
    async display(section, target) {
        return default_1.default.prototype.display
    ...
    check(_offsetLeft, _offsetTop) {
        ...
        const writingMode = this.writingMode && this.writingMode.indexOf('vertical') === 0
            ? 'vertical'
            : 'horizontal';
    ...
    addScrollListeners() {
        ...
        const dir = this.settings.direction === 'rtl' &&
    ...
    next() {
        const delta = this.layout.props.name === 'pre-paginated' && this.layout.props.spread
    ...
    updateFlow(flow) {
        ...
        if (this.rendered && this.isPaginated && this.settings.snap) {
            this.snapper = new snap_1.default(this, typeof this.settings.snap === 'object'
                ? this.settings.snap
                : {});
        }
    }
