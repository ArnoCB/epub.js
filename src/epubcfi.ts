...
class EpubCFI {
  ...
  constructor(
    ...
    console.log('[EpubCFI] Detected type:', type);
  ...
  fromRange(
    ...
    console.log('[EpubCFI.fromRange] Range:', range);
    ...
    if (isDOMRange(range)) {
      console.log('[EpubCFI.fromRange] Range is a DOM Range');
      ...
      console.warn(
        '[EpubCFI.fromRange] Range is not a DOM Range, using custom range'
      );
      start = end = range;
