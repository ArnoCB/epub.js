...
class Annotations {
   ...
   */
  highlight(cfiRange: string, data: object, cb?: (annotation: Annotation) => void, className?: string, styles?: object) {
   ...
   */
  underline(cfiRange: string, data: object, cb?: (annotation: Annotation) => void, className?: string, styles?: object) {
