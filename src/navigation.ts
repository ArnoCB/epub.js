...
class Navigation {
  public toc: unknown[] = [];
  public tocByHref: { [key: string]: number } = {};
  public tocById: { [key: string]: number } = {};
  public landmarks: unknown[] = [];
  public landmarksByType: { [key: string]: number } = {};
   ...
   */
  get(target: string): unknown | undefined {
   ...
   * @return {object} navItem
   */
  getByIndex(target: string, index: number | undefined, navItems: unknown[]): unknown | undefined {
   ...
   */
  landmark(type: string): unknown | undefined {
    if (!type) {
   ...
   */
  private parseNav(navHtml: Document): unknown[] {
   ...
   * @return {array} navigation list
   */
  parseNavList(navListHtml: Document, parent?: string | undefined): unknown[] {
   ...
   * @return {object} navItem
   */
  private navItem(item: Element, parent: string | undefined): unknown | undefined {
    ...
    let subitems = [];
    const nested = filterChildren(item, 'ol', true);
    if (nested) {
   ...
   * @return {object} landmarkItem
   */
  private landmarkItem(item: Element): unknown | undefined {
   ...
   * @return {array} navigation list
   */
  private parseNcx(tocXml: Document): unknown[] {
   ...
   */
  load(json: { [key: string]: unknown }[]): unknown[] {
