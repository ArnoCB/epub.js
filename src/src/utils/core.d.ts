 ...
 * @memberof Core
 */
export declare function qs(el: Element, sel: string): Element | null;
/**
 * querySelectorAll polyfill
 * @memberof Core
 * @deprecated Use `Element.querySelectorAll` directly instead.
 */
export declare function qsa(el: Element, sel: string): NodeListOf<Element> | HTMLCollectionOf<Element>;
/**
 ...
 * querySelector by property
 */
export declare function qsp(el: Element, sel: string, props: Record<string, string>): Element | null;
/**
 ...
 * @memberof Core
 */
export declare function filterChildren(el: Element, nodeName: string, single: boolean): ChildNode[];
/**
