...
class Rendition {
  constructor(book, options) {
    ...
    this.manager.on(
      constants_1.EVENTS.MANAGERS.ORIENTATION_CHANGE,
      (...args) => {
  ...
  async start() {
    ...
    this.direction(
      this.book.packaging.metadata.direction || this.settings.defaultDirection
    );
    ...
    this.manager.on(
      constants_1.EVENTS.MANAGERS.ADDED,
      this.afterDisplayed.bind(this)
    );
    this.manager.on(
      constants_1.EVENTS.MANAGERS.REMOVED,
      this.afterRemoved.bind(this)
    );
    // Listen for resizing
    this.manager.on(
      constants_1.EVENTS.MANAGERS.RESIZED,
    ...
    this.manager.on(
      constants_1.EVENTS.MANAGERS.SCROLLED,
   ...
   */
  afterDisplayed(view) {
    view.on(constants_1.EVENTS.VIEWS.MARK_CLICKED, (cfiRange, data) =>
  ...
  onResized(size, epubcfi) {
     ...
     */
    this.emit(
      constants_1.EVENTS.RENDITION.RESIZED,
      {
        width: size.width,
        height: size.height,
      },
  ...
  triggerMarkEvent(cfiRange, data, contents) {
     ...
     */
    this.emit(
      constants_1.EVENTS.RENDITION.MARK_CLICKED,
      cfiRange,
      data,
      contents
    );
