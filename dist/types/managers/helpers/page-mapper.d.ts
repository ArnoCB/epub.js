...
export declare class PageMapper {
     ...
     */
    detectFlow(viewSettings: ViewSettings, view: ViewLike, chapter: ChapterLike): FlowDetectionResult;
    /**
     ...
     */
    mapPaginatedPages(doc: Document, body: HTMLElement, section: Section, pageCount: number, config: PaginatedProbeConfig, flowResult: FlowDetectionResult): Promise<PageMapEntry[]>;
    /**
     ...
     */
    mapScrolledPages(doc: Document, body: HTMLElement, section: Section, pageCount: number, config: ScrolledProbeConfig, flowResult: FlowDetectionResult): Promise<PageMapEntry[]>;
    /**
