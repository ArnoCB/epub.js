import { default as default_0 } from "JSZip";
...
exports.OB = replaceBase;
exports.rG = replaceCanonical;
exports.Kj = replaceMeta;
exports.iQ = replaceLinks;
exports.V2 = substitute;
var url_1 = __webpack_require__(293);
...
class Section {
   ...
   */
  load(_request) {
    var request = _request || this.request || utils_request/* default */.A;
   ...
   */
  base() {
    return (0,replacements/* replaceBase */.OB)(this.document, this);
  }
...
class Spine {
  constructor() {
    ...
    this.hooks.content.register(replacements/* replaceBase */.OB);
    this.hooks.content.register(replacements/* replaceCanonical */.rG);
    this.hooks.content.register(replacements/* replaceMeta */.Kj);
...
class Resources {
   ...
   */
  createUrl(url) {
    var parsedUrl = new utils_url["default"](url);
  ...
  createCssFile(href) {
    ...
    var relUrls = this.urls.map(assetHref => {
      ...
      var relative = new utils_path["default"](absolute).relative(resolved);
      return relative;
    });
    if (!textResponse) {
    ...
    return textResponse.then(text => {
      ...
      text = (0,replacements/* substitute */.V2)(text, relUrls, this.replacementUrls);
  ...
  substitute(content, url) {
    ...
    return (0,replacements/* substitute */.V2)(content, relUrls, this.replacementUrls);
  }
  destroy() {
...
class Themes {
  ...
  registerUrl(name, input) {
    var url = new utils_url["default"](input);
    this._themes[name] = {
      url: url.toString()
    };
    if (this._injected[name] || name == 'default') {
...
class Contents {
   ...
   */
  linksHandler() {
    (0,replacements/* replaceLinks */.iQ)(this.content, href => {
...
class Archive {
  ...
  openUrl(zipUrl, isBase64) {
    return (0,utils_request/* default */.A)(zipUrl, 'binary').then(function (data) {
  ...
  request(url, type) {
    ...
    var response;
    var path = new utils_path["default"](url);
...
class Store {
  constructor(name, requester, resolver) {
    ...
    this.name = name;
    this.requester = requester || utils_request/* default */.A;
...
class Book {
  constructor(url, options) {
     ...
     * @private
     */
    this.request = this.settings.requestMethod || utils_request/* default */.A;
  ...
  open(input, what) {
    ...
    if (type === INPUT_TYPE.BINARY) {
      this.archived = true;
      this.url = new utils_url["default"]('/', '');
      ...
      this.url = new utils_url["default"](input);
   ...
   */
  openPackaging(url) {
    this.path = new utils_path["default"](url);
    return this.load(url).then(xml => {
  ...
  determineType(input) {
    ...
    url = new utils_url["default"](input);
    path = url.path();
  ...
  store(name) {
    ...
    let requester = this.settings.requestMethod || utils_request/* default */.A.bind(this);
    // Create new Store
